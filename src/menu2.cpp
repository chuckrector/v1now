...
parseloop:
  ...
  if (strcmp((const char *)strbuf, ":selectors") == 0)
  {
    ...
    {
      fscanf(f, "%s", strbuf);
      menus[i].posx = atoi((const char *)strbuf) + 16;
      fscanf(f, "%s", strbuf);
      menus[i].posy = atoi((const char *)strbuf) + 16;
    }
    goto parseloop;
  }
  fclose(f);
...
DrawEquipMenu(char c, char ptr)
{
  ...
  if (items[a].equipflag && equip[items[a].equipidx].equipable[l])
  {
    ...
    gotoxy(26, 124);
    printstring((char *)"ATK ");
    dec_to_asciiz(pstats[l].atk, strbuf);
    gotoxy(80 - (strlen((const char *)strbuf) * 8), 124);
    printstring(strbuf);
    printstring((char *)">");
    ...
    fontcolor(31);
    gotoxy(26, 133);
    printstring((char *)"DEF ");
    dec_to_asciiz(pstats[l].def, strbuf);
    gotoxy(80 - (strlen((const char *)strbuf) * 8), 133);
    printstring(strbuf);
    printstring((char *)">");
    ...
    fontcolor(31);
    gotoxy(26, 142);
    printstring((char *)"HIT ");
    dec_to_asciiz(pstats[l].hitc, strbuf);
    gotoxy(80 - (strlen((const char *)strbuf) * 8), 142);
    printstring(strbuf);
    printstring((char *)">");
    ...
    fontcolor(31);
    gotoxy(26, 151);
    printstring((char *)"DOD ");
    dec_to_asciiz(pstats[l].dodc, strbuf);
    gotoxy(80 - (strlen((const char *)strbuf) * 8), 151);
    printstring(strbuf);
    printstring((char *)">");
    ...
    fontcolor(31);
    gotoxy(26, 160);
    printstring((char *)"MAG ");
    dec_to_asciiz(pstats[l].magc, strbuf);
    gotoxy(80 - (strlen((const char *)strbuf) * 8), 160);
    printstring(strbuf);
    printstring((char *)">");
    ...
    fontcolor(31);
    gotoxy(26, 169);
    printstring((char *)"MGR ");
    dec_to_asciiz(pstats[l].mgrc, strbuf);
    gotoxy(80 - (strlen((const char *)strbuf) * 8), 169);
    printstring(strbuf);
    printstring((char *)">");
    ...
    fontcolor(31);
    gotoxy(26, 178);
    printstring((char *)"REA ");
    dec_to_asciiz(pstats[l].reac, strbuf);
    gotoxy(80 - (strlen((const char *)strbuf) * 8), 178);
    printstring(strbuf);
    printstring((char *)">");
    ...
    fontcolor(31);
    gotoxy(26, 187);
    printstring((char *)"FER ");
    dec_to_asciiz(pstats[l].ferc, strbuf);
    gotoxy(80 - (strlen((const char *)strbuf) * 8), 187);
    printstring(strbuf);
    printstring((char *)">");
    ...
    fontcolor(31);
    gotoxy(26, 196);
    printstring((char *)"MBL ");
    dec_to_asciiz(pstats[l].mblc, strbuf);
    gotoxy(80 - (strlen((const char *)strbuf) * 8), 196);
    printstring(strbuf);
    printstring((char *)">");
