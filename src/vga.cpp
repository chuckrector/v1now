...
void
copytile(int x, int y, unsigned char *spr)
{
  //   asm("movl $16, %%ecx                  \n\t"
  //       "movl %2, %%esi                   \n\t"
  //       "movl %1, %%edi                   \n\t"
...
void
copysprite(int x, int y, int width, int height, unsigned char *spr)
{
  // asm("movl %3, %%edx                   \n\t"
  //       "movl %4, %%esi                   \n\t"
  // "csl0:                                  \n\t"
...
void
grabregion(int x, int y, int width, int height, unsigned char *spr)
{
  // asm("movl %3, %%edx                   \n\t"
  //       "movl %4, %%edi                   \n\t"
  // "grl0:                                  \n\t"
...
void
tcopytile(int x, int y, unsigned char *spr, unsigned char *matte)
{
  //   asm("movl $16, %%ecx                  \n\t"
  //       "movl %2, %%esi                   \n\t"
  //       "movl %1, %%edi                   \n\t"
...
void
BuildTable(char r, char g, char b, unsigned char *dest)
{
  int i;
...
void
ColorScale(unsigned char *dest, int st, int fn, int inv)
{
  int i, intensity;
