...
ProcessEquipDat()
{
  ...
  pl1:
    ...
    {
      fgets((char *)strbuf, 99, f);
      goto pl1;
    }
    if (!strcmp((char *)strbuf, "ATK"))
    {
      fscanf(f, "%s", strbuf);
      equip[i].str = atoi((const char *)strbuf);
      goto pl1;
    }
    if (!strcmp((char *)strbuf, "DEF"))
    {
      fscanf(f, "%s", strbuf);
      equip[i].end = atoi((const char *)strbuf);
      goto pl1;
    }
    if (!strcmp((char *)strbuf, "MAG"))
    {
      fscanf(f, "%s", strbuf);
      equip[i].mag = atoi((const char *)strbuf);
      goto pl1;
    }
    if (!strcmp((char *)strbuf, "MGR"))
    {
      fscanf(f, "%s", strbuf);
      equip[i].mgr = atoi((const char *)strbuf);
      goto pl1;
    }
    if (!strcmp((char *)strbuf, "HIT"))
    {
      fscanf(f, "%s", strbuf);
      equip[i].hit = atoi((const char *)strbuf);
      goto pl1;
    }
    if (!strcmp((char *)strbuf, "DOD"))
    {
      fscanf(f, "%s", strbuf);
      equip[i].dod = atoi((const char *)strbuf);
      goto pl1;
    }
    if (!strcmp((char *)strbuf, "MBL"))
    {
      fscanf(f, "%s", strbuf);
      equip[i].mbl = atoi((const char *)strbuf);
      goto pl1;
    }
    if (!strcmp((char *)strbuf, "FER"))
    {
      fscanf(f, "%s", strbuf);
      equip[i].fer = atoi((const char *)strbuf);
      goto pl1;
    }
    if (!strcmp((char *)strbuf, "REA"))
    {
      fscanf(f, "%s", strbuf);
      equip[i].rea = atoi((const char *)strbuf);
      goto pl1;
    }
    if (!strcmp((char *)strbuf, "ONEQUIP"))
    {
      fscanf(f, "%s", strbuf);
      equip[i].onequip = atoi((const char *)strbuf) + 1;
      goto pl1;
    }
    if (!strcmp((char *)strbuf, "ONDEEQUIP"))
    {
      fscanf(f, "%s", strbuf);
      equip[i].ondeequip = atoi((const char *)strbuf) + 1;
      goto pl1;
    }
